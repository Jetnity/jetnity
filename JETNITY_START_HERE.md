...
- `docs/VISITOR_SEARCH_COUNTRY_ALIAS_PRODUCTION_RECOVERY_POST_MERGE_SMOKE_2026-08-29.md` – PR #173 gemergt; Live Production API smoke PASS; Issue #109 offen bis TL/PO Close; kein Issue #110
...
**Aktuell: PR #173 GEMERGT / Issue #109 OPEN. Live-Evidence gewinnt.**

- PR #173 ist der Visitor-Search-Country-Alias-Recovery-Transport. Exact reviewed head `d44d9a7f`, merge `ade03511`. Live Production API smoke PASS. Exakt erster unfertiger Schritt = Technical Lead / Product Owner entscheidet über Close von Issue #109. Autor-Agent schliesst das Issue nicht. Kein Issue #110. Keine Vercel-Setting-Mutation.
...
Issue #109 ist nach PR #173 und Live-API-Smoke erfüllt, bleibt aber offen bis TL/PO Close. Issue #110 (spätere Homepage-Multi-Destination-Absicht) bleibt ungestartet.
