...
Current repository `main` (re-read 22 September 2026, Continuity Refresh 3 C1–C3):

`0d4c871867e7c4daac45af4a737cc032723863ae` — Merge #552: independently reviewed account-count verification evidence (**evidence-only**; not application runtime)

Later-than-#548 non-runtime merges on that ancestry: #549 docs-only inventory `e28ab43b`; #550 local/unapplied account-count proof `34686af3` (accepted `b5bbe211`; **not** a rendered-product runtime baseline).
...
#550 is **CLOSED / MERGED / POST-MERGE VERIFIED** and remains **LOCAL / UNAPPLIED** candidate SQL + disposable proof. Do not label it as the current application-runtime baseline. #552 is closed evidence-only.
...
Present continuation: `docs/CHATGPT_NEW_CHAT_CHECKPOINT_2026-09-22.md`. The file already exists on `main` from #546; while #551 is open, read the corrected Refresh-3 content from this branch. Reconstruct closed #550 (local/unapplied) and closed #552 (Cursor specialist evidence, not Guardian). Remaining assigned current work is this #551 persist. Closed #512/#506/#509/#510/#543/#544/#545/#546/#547/#548/#549/#550/#552 are not current writers. This continuity persist owned only the named global startup/current-state files. After #551, account-count Production/exposure remains separately gated and is not auto-dispatched.
