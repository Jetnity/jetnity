...
> **PR #192 CLOSED AS DUPLICATE / NON-CANONICAL.** Branch/Task nicht als kanonische Evidence verwenden. Kein Merge, kein Ersatz-PR. `docs/TRAVELLER_ACCOUNT_MULTICITIZENSHIP_GAP_STATUS_2026-08-29.md`.
