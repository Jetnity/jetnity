...
const ZUSTAENDE = {
  ...
  'readiness-official-current': {
    kompakt: 'Offiziell nicht erforderlich',
    desktop: 'Offiziell nicht erforderlich',
    oeffneVorbereitung: true,
    nutzlast: {
      reise: reise({
        travellers: 1,
  ...
  'safety-unavailable': {
    kompakt: 'Sicherheitshinweise können derzeit nicht geprüft werden',
    desktop: 'Sicherheitshinweise können derzeit nicht geprüft werden',
    nutzlast: {
      reise: reise(),
      safetyEvaluations: [
        {
          ...
          affectedRefs: [],
          impact: [],
          reason: 'Kein Safety-Provider aktiv.',
          nextAction: 'observe',
          conflict: false,
          ...
          contextFingerprint: 'safety-ctx-v1',
          eventFingerprint: 'safety-evt-v1',
        },
      ],
    },
  },
  'safety-kritisch-eine-etappe': {
    kompakt: 'Kritische Warnung',
    desktop: 'Florenz',
    nutzlast: {
      reise: reise({
        stages: [
          etappe({ id: 'stage-1', name: 'Florenz', countryCode: 'IT', placeId: 'geonames:3176959' }),
          etappe({ id: 'stage-2', name: 'Rom', countryCode: 'IT', position: 2, placeId: 'geonames:3169070' }),
        ],
      }),
      safetyEvaluations: [
        {
          factId: 'safety:eq-firenze',
          factKey: 'eq-firenze',
          category: 'earthquake',
          eventStatus: 'active',
          ...
          presentationClass: 'critical_warning',
          sourceSeverity: 'extreme',
          advisoryClass: 'do_not_travel',
          authorityClass: 'official_government',
          affectedRefs: [{ kind: 'stage', id: 'stage-1', label: 'Florenz' }],
          impact: [{ domain: 'stage', ref: { kind: 'stage', id: 'stage-1', label: 'Florenz' }, status: 'affected' }],
          ...
          evidence: {
            ...
            summary: 'Regionale Erschütterungen.',
          },
          contextFingerprint: 'safety-ctx-v1',
          eventFingerprint: 'safety-evt-v1',
        },
  ...
  'seasonal-kein-provider': {
    kompakt: 'Einreise & Reisevorbereitung',
    desktop: 'Einreise & Reisevorbereitung',
    ohneText: 'Reisezeit & Saison',
    nutzlast: { reise: reise() },
  },
  'seasonal-unavailable': {
    kompakt: 'Saisonale Hinweise können derzeit nicht geprüft werden',
    desktop: 'Saisonale Hinweise können derzeit nicht geprüft werden',
    nutzlast: {
      reise: reise(),
  ...
  'seasonal-timing-notice': {
    kompakt: 'Reisezeit prüfen',
    desktop: 'Bangkok',
    nutzlast: {
      reise: reise({
        stages: [etappe({ id: 'stage-bkk', name: 'Bangkok', countryCode: 'TH', placeId: 'geonames:1609350' })],
      }),
      seasonalEvaluations: [
        seasonalEvaluation({
          factId: 'seasonal:rain-th',
          factKey: 'rain-th',
          category: 'monsoon',
          ...
          affectedRefs: [{ kind: 'stage', id: 'stage-bkk', label: 'Bangkok' }],
          impact: [{ domain: 'stage', ref: { kind: 'stage', id: 'stage-bkk', label: 'Bangkok' }, status: 'affected' }],
          reason: 'Saisonaler Kontext auf Landesebene, ohne erfundene regionale Präzision.',
          nextAction: 'review_timing',
          evidence: {
            provider: 'audit',
            authority: 'Audit Climate',
            authorityClass: 'official_climate',
            ...
            summary: 'Der Aufenthalt fällt typischerweise in die stärkere Regenzeit.',
  ...
  'seasonal-mixed-tradeoff': {
    kompakt: 'Saisonaler Hinweis',
    desktop: 'typische saisonale Trade-offs',
    nutzlast: {
      reise: reise(),
      seasonalEvaluations: [
        seasonalEvaluation({
          ...
          evidence: {
            ...
            checkedAt: JETZT,
            freshUntil: '2026-12-31T00:00:00.000Z',
            headline: 'Saisonaler Trade-off',
            summary: 'Typische Nachteile und mögliche ruhigere Reisezeit.',
            referencePeriod: { startYear: 1991, endYear: 2020 },
          },
        }),
      ],
  ...
  'seasonal-insufficient': {
    kompakt: 'nicht belastbar prüfbar',
    desktop: 'nicht belastbar prüfbar',
    nutzlast: {
      reise: reise(),
      seasonalEvaluations: [
        seasonalEvaluation({
    ...
    nutzlast: {
      ...
      seasonalEvaluations: [
        seasonalEvaluation({
          ...
          relevance: 'applies',
          presentationClass: 'unknown',
          reason: 'Die saisonale Quelle muss erneut geprüft werden.',
        }),
      ],
    },
  },
  ...
  'seasonal-multi-destination': {
    kompakt: 'Kochi',
    desktop: 'Kochi',
    nutzlast: {
      reise: reise({
        stages: [
          etappe({ id: 'stage-goa', name: 'Goa', countryCode: 'IN', placeId: 'geonames:1271157' }),
          etappe({ id: 'stage-kerala', name: 'Kochi', countryCode: 'IN', position: 2, placeId: 'geonames:1273874' }),
        ],
      }),
      seasonalEvaluations: [
        seasonalEvaluation({
          factId: 'seasonal:rain-kerala',
          factKey: 'rain-kerala',
          category: 'monsoon',
          outcome: 'less_favorable',
          evidenceStatus: 'current',
          freshness: 'current',
          relevance: 'applies',
          spatialPrecision: 'place',
          presentationClass: 'timing_check',
          affectedRefs: [{ kind: 'stage', id: 'stage-kerala', label: 'Kochi' }],
          impact: [{ domain: 'stage', ref: { kind: 'stage', id: 'stage-kerala', label: 'Kochi' }, status: 'affected' }],
          evidence: {
            provider: 'audit',
            authority: 'Audit Climate',
            authorityClass: 'official_climate',
            ...
            checkedAt: JETZT,
            freshUntil: '2026-12-31T00:00:00.000Z',
            headline: 'Monsun in Kerala',
            summary: 'Der Aufenthalt in Kochi fällt typischerweise in die Monsunzeit.',
            referencePeriod: { startYear: 1991, endYear: 2020 },
          },
        }),
      ],
...
function seasonalEvaluation(teil = {}) {
  return {
    factId: 'seasonal:unavailable',
    factKey: 'unavailable',
    category: 'unknown',
    evidenceClass: 'seasonal_pattern',
    outcome: 'unknown',
    ...
    contextFingerprint: 'seasonal-context-v1',
    factFingerprint: 'seasonal-fact-v1',
    ...teil,
  }
}
