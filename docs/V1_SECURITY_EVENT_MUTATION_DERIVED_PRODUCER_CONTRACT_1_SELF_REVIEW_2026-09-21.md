...
| Main-drift integration | Live `#498`, `#497`, `#502`, `#500`, then `#504` merged; incoming files unchanged; contract / proof files not rewritten; no extra ownership. | merge-base `9f386d10`; those paths identical to `origin/main` |
