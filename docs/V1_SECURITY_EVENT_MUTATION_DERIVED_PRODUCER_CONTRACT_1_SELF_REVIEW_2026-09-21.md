...
| Main-drift integration | Live `#498` then `#497` merged; hunter and reconciliation docs unchanged; contract not rewritten; no extra ownership. | merge-base `546b33d9`; those paths identical to `origin/main` |
