...
| `aacba1-review-fix-20260923T101352Z-*.json` | H1–H4 review-fix helper/preflight receipts. Do not overwrite. |
| later `aacba1-review-fix-*` files | B1/B2 residual receipts. Historical and H1–H4 files stay dated. |
