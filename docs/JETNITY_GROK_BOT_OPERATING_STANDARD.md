...
Canonical first event-trigger slice is **Guardian PR/CI/Release Assurance**. Output `/workspace/jetnity/intelligence/events/guardian-latest.json`. Independent assurance only. No Ready/Merge. No Production/Auth/RLS mutation. No automatic GitHub mutation. Narrow matching only.
