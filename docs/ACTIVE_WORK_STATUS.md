...
4. **Bereits umgesetzt:** Funktionale P1-Fixes bleiben erhalten. Lint-Ursache von CI #1207 war `scripts/server-only-empty.cjs` gegen ESLint-9/react-hooks-Plugin-Auflösung, behoben durch lint-sicheren `.js`-Stub. Continuity gegen live `main` / Checkpoint V2 reconciled. Lokale Gates auf `92fff45c`: typecheck, lint 0/135, 2657 tests, hygiene, Production-Build.
