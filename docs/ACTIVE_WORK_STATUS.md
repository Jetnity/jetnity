...
> **Self-expiring / dual-state.** Live-Evidence gewinnt. Solange PR #144 offen und unmerged ist, ist der Continuity-Transport Draft-PR #144; exakte Aktion = unabhängiger TL-Re-Review; kein Agent-Ready/Merge/Runtime. Sobald Live-Evidence #144 als gemergt zeigt, ist diese Klausel automatisch historisch: Gate 0 = integrierte Architecture-Evidence; **#144 ist nicht mehr aktiv**; keine AP-7-Runtime autorisiert; exakte nächste Aktion = Product-Owner-Architekturentscheidung/Gate vor jeder Implementation (Dual-Authority ist Gate-0/TL-Empfehlung, vom Product Owner nicht freigegeben); Generation 11 abgeschlossen und nicht für Implementation wiederverwenden. Keine zukünftige Merge-SHA. Kein Continuity-PR nur für den Merge. PR #143 bleibt MERGED (`1947285c`).
...
11. **Exakter nächster Schritt:** **Dual-State.** Solange PR #144 offen/unmerged: unabhängiger Technical-Lead-Exact-Head-Re-Review nach `5455342054`; kein Ready, kein Merge, keine Runtime. Sobald Live-Evidence #144 als gemergt zeigt: #144 nicht mehr aktiv; Gate 0 = integrierte Architecture-Evidence; exakte nächste Aktion = Product-Owner-Architekturentscheidung/Gate vor jeder Implementation (Dual-Authority ist Gate-0/TL-Empfehlung, vom Product Owner nicht freigegeben); Generation 11 abgeschlossen und nicht für Implementation wiederverwenden. Keine zukünftige Merge-SHA. Kein Continuity-PR nur für den Merge.
