...
Status: **Ziel-IA angenommen (ADR-0163). TW-1, TW-2, TW-4, TW-3, TW-5, TW6-A und TW6-B Runtime sind auf `main` integriert. TW-7-Start-Gate ist erfüllt; Spec durch PR #100 integriert. TW7-A Runtime ist durch Issue #103 gestartet und noch nicht gemergt.**  
...
Verbindliche Slice-Spec: `docs/TRIP_WORKSPACE_TW7_HUB_GAP_TASK.md`. Status: `docs/TRIP_WORKSPACE_TW7_HUB_GAP_STATUS.md`. TW-7-Gap / ADR-0176 / TW7-A-Spec sind durch PR #100 integriert. **TW7-A Runtime ist durch Issue #103 gestartet und noch nicht gemergt.**
