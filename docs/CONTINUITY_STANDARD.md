...
- Visitor Search Country Alias Ranking (Issue #109): Recovery-Wahrheit ist `docs/VISITOR_SEARCH_COUNTRY_ALIAS_PRODUCTION_RECOVERY_TASK_2026-08-29.md`, `docs/VISITOR_SEARCH_COUNTRY_ALIAS_PRODUCTION_RECOVERY_STATUS_2026-08-29.md`, `docs/VISITOR_SEARCH_COUNTRY_ALIAS_PRODUCTION_RECOVERY_HANDOFF_2026-08-29.md`. Historischer Slice: `docs/VISITOR_SEARCH_COUNTRY_ALIAS_RANKING_TASK_2026-08-29.md` und zugehörige Status/Handoff. Operative Git-/PR-Wahrheit bleibt `JETNITY_HANDOFF.md` und `docs/ACTIVE_WORK_STATUS.md`.
...
- Binding Slice Precheck / Continuity Gate (PR #196): `docs/JETNITY_BINDING_SLICE_PRECHECK_AND_CONTINUITY_GATE_2026-08-29.md` und `docs/CHATGPT_TL_BINDING_SLICE_PRECHECK_CONTINUITY_CHECKPOINT_2026-08-29.md`. Kein neuer Slice vor Live-Rekonstruktion. Kein Handoff ohne Continuity.
- Authoritative current-state checkpoint (PR #194/#195): `docs/CHATGPT_TL_LIVE_RECONSTRUCTION_CHECKPOINT_2026-08-29_V2.md`. `main` live prüfen; die Reconstruction-Baseline ist keine dauerhafte Current-Head-Wahrheit.
