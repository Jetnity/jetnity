...
Remote-Heads live: **136** inkl. `main` und `cursor/project-sanitation-closure-2966`

> In diesem Slice wird **kein** Branch gelöscht.  
> Branch-Delete ist unabhängig von PR-Close. Ein geschlossener PR schützt Unique Files nicht, wenn danach der Branch gelöscht wird.
...
| --- | --- | --- | --- |
| `main` | `51b0c926dbb535` | 0 / 0 | Integrationsbranch; PR #133 integriert |
| `cursor/project-sanitation-closure-2966` | dieser Slice | 0 behind vs `51b0c926` | laufender Closure-Draft #135 |

`cursor/ap5-s1-security-ui-8b13` ist **nicht** mehr ACTIVE. Siehe Leftover.
...
| --- | --- | --- | --- |
| `audit/admin-platform-sync-temp` | `e6b3e62c` | identisch mit `…-temp2`; Unique Files ⊂ PR #39/#40 | nein, sofern #40/#39-**Branches** bleiben |
| `audit/admin-platform-sync-temp2` | `e6b3e62c` | Duplikat | nein |
| `docs/chatgpt-technical-lead-handoff-2026-08-24-shadow` | `216b44d9` | identisch mit beiden domain-policy-Branches; Unique ⊂ PR #52 | nein, sofern #52-**Branch** bleibt |
...
Voraussetzung: HISTORICAL-EVIDENCE-**Branches** von #39/#40/#52 bleiben oder ihre Unique Files sind archiviert. Offener oder geschlossener PR-Zustand reicht nicht.

### Menge B – Ancestor-Leftovers (81)

Abschnitt 7.1. Proof: `git merge-base --is-ancestor <tip> origin/main`.  
Inklusive `cursor/ap5-s1-security-ui-8b13`.

### Menge C – Squash-/Status-Leftovers ohne Unique Files (33)

Abschnitt 7.2. Proof: Unique Files vs Merge-Base = 0.  
Inklusive `cursor/s1-merged-status-f23f` nach oder unabhängig vom PR-Close von #50.
...
- Unique Audit-Pläne auf den Branches von #39/#40
- Unique Continuity-Snapshots auf dem Branch von #52
- Unique Collaboration-Spec auf #28
- Unique Inventur-Dateien auf dem Branch von #88
...
PR-Close allein schützt keine dieser Dateien.
...
Eine Close-Liste für PRs ist eine **andere** Freigabe.
