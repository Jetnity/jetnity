...
| Approved read-only routines/schedules authorized once | Which routines, cadence, who authorized | **open — Daily V2 ACTIVE / durable daily archive required before weekly complete / trigger still OPEN** | Exact continuation: `docs/CHATGPT_NEW_CHAT_CHECKPOINT_2026-09-18.md` §0 (`5741925172`). NEXT EXACT STEP is the CoS archive writer, then weekly synthesis. This is not HOLD exit. |
