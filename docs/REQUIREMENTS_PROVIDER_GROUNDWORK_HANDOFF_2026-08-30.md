...
Review-Fix von comment **#5471442167** gegen Head `9caa1a0ff45eeea27bc042d75e736dcb17bd589d`
...
3. die sechs Agent-Deliverables (Review-Fix CR-1–CR-4 nur hier):
...
- Sherpa ist der klarste öffentliche Travel-API-Kandidat, nicht gewählt. **CR-2:** Origin-Nationality-Fallback (E-SHERPA-4) ist **verboten**. **CR-3:** öffentliche Quota-/Cache-Schichten ≠ kontrahierte Production-Wahrheit.
...
4. CR-2/CR-3/CR-4 gegen Evidence-Log und Gap-Map prüfen; Marketing nicht als Vertrag lesen.
