...
- `npm test` 3661/3661 was taken on product tree `a71d3b5d`. Later evidence/docs commits do not change the owned runtime copy sources.
- Unchanged first-slice screens remain bound to `7a143fec`. New same-place screens are bound to `a71d3b5d`.
