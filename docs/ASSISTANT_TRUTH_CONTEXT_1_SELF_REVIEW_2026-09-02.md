...
| Collapse destination and transit official for the same country | Rejected. Separate `scope` records and fingerprints. Transit uses `requirementType === 'transit'` or `transitCountryCode != null`. |
