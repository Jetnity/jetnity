...
3. Read `model_usage` with the existing admin path or an authorized SQL **read**. A failed read is not zero. The 200-row admin window can truncate a busy period.
