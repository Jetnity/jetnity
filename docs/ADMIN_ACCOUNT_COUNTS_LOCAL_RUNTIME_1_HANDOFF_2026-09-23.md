...
3. Binding TL re-review `5294684706` on `e09b4ebc1eadd9ebf950a22fff4ad41b60897556` (CHANGES REQUIRED) — this head is the same-session C1/C2 package
4. Independent diagnostic spec comment `5799942948`
...
- Do not duplicate this 5294684706 correction if already present on the current head
...
| Capability | Code after 5294684706 | Executed here |
| --- | --- | --- |
...
| Exact consumer artifact export-before-delete | yes | real temp files with TL names |
