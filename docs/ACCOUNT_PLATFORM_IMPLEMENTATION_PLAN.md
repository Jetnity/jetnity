...
| Reihenfolge | Default nächster **Account-Programm**-Kandidat nach P2-TA-03. Gate 0 und S1–S4 sind integriert. AP-5-S4 startet **kein** S5. Folgeslices AP-5-S5 vs. AP-5-P1–P5 stehen im Gate-0-Status und brauchen eigene Tasks. |
