...
- Persistenz ist S5-B. Zielarchitektur ist Option C (ADR-0197). Repository-Übersetzung ist ADR-0198. Production-Apply bleibt extra gegatet. Dieser ADR wird dadurch nicht umgedeutet.
