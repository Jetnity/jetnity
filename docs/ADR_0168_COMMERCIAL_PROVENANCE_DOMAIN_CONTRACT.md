...
Status: **S5-A integriert auf `main` via PR #83 / `3b317bc6`. S5-B Zielarchitektur Option C angenommen (ADR-0197 / PR #180). S5-B Runtime/Persistenz nicht gestartet. Keine Persistenz.**
