...
Status: **Product-Owner-verbindlich; Änderung der Reihenfolge nur durch neue ausdrückliche Product-Owner-Entscheidung. Operativer Integrationsstand: TW6-REST-01 ist durch PR #87 integriert. TW-7-Start-Gate und Spec sind integriert. TW7-A Runtime ist durch Issue #103 gestartet und noch nicht gemergt. Ältere Checkpoints, die `TW6-REST-01` offen lassen oder TW7-A als ungestartet führen, sind historische Evidence. D0-1/D0-2 und P1-D0-LIVE-01 sind integriert; das ist kein D1/G1 und kein Domain-Cutover.**
...
8. TW-7 / TW-8 nur nach ihren dokumentierten Abhängigkeiten/Gates. TW-7-Start-Gate ist erfüllt; Spec steht in `docs/TRIP_WORKSPACE_TW7_HUB_GAP_TASK.md`. TW7-A Runtime ist durch Issue #103 gestartet und noch nicht gemergt. TW-8 bleibt hinter Provider S5 **und** realer Commercial Provenance.
