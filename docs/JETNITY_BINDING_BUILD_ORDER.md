...
8. TW-7 / TW-8 nur nach ihren dokumentierten Abhängigkeiten/Gates. TW-7-Start-Gate ist gegen `main` erfüllt; Rest-Gap und TW7-A-Slice stehen in `docs/TRIP_WORKSPACE_TW7_HUB_GAP_TASK.md`. TW7-A Runtime: Draft zu Issue #103, nicht auf `main` (`docs/TRIP_WORKSPACE_TW7_A_STATUS.md`). Das ist **keine** Merge-Freigabe. TW-8 bleibt hinter Provider S5 **und** realer Commercial Provenance.
