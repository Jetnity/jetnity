...
Integrated live main: `main@9f386d10816d7adcdaf2fcd6d3732e64f952fb50` (#504 after #500/#502/#497/#498; audit docs and proof files unchanged)  
...
- **Main integration:** merged `#498`, `#497`, `#502`, `#500`, then live `main@9f386d10` (#504). Incoming audit/runtime files are unmodified. Security contract / local proof files were not changed for these integrates. #494 ownership remains the producer-contract files only.
...
- merge-base / behind versus live `main@9f386d10` (must be 0)
- review threads 0

Dispatch base `4169c5b4` remains the historical start. Live main `#498`, `#497`, `#502`, `#500`, then `#504` is integrated; those files are not owned by this slice.
