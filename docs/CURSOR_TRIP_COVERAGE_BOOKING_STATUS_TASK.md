...
Visibility-Fix: inaktive Wrapper tragen nur `hidden`, nicht `grid`. `inert` per `setAttribute`. Trip-Workspace-Audit **278/0** inklusive Wechselketten. Activities **184/0**. iPhone-Nachtest offen.
