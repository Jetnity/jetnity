...
S5 ist in S5-A (Domainvertrag, auf `main` via PR #83) und S5-B (Persistenz) getrennt. S5-A implementiert **keinen** Offer-Monolithen. S5-B Zielarchitektur ist Option C (ADR-0197). Repository-Übersetzung ist ADR-0198 / Draft-PR #182. Production-Apply und TW-8 bleiben extra gegatet. Keine Provideraktivierung.
