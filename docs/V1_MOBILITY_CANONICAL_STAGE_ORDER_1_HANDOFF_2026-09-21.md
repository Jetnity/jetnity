...
5. No merge of #494, #497 or sibling P2 branches.
6. Exact-head CI / Auth / Preview IDs in the PR comment, not an extra evidence commit.
7. This handoff is not Technical-Lead PASS.
