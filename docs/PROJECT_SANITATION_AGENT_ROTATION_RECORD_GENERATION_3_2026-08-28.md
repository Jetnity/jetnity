...
- Live-`main` hat sich seit 26.08. materiell bewegt (`eaa03ad7` vs. `1d558ef5`)
...
Aktiv für diesen Closure-Draft. Nach STOPP und unabhängigem Technical-Lead-Review ist Generation 3 historische Authoring-Evidence und nicht wiederzuverwenden.
