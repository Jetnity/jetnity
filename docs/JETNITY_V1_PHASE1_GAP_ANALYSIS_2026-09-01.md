...
| Destination Essentials | **IN IMPLEMENTATION / Draft-PR, nicht auf main** | Safety/Disruption und Seasonal Foundations, Entry-Requirement-Truth-Architektur, Presentation-Helper `lib/trips/destination-essentials.ts` | Technical-Lead Exact-Head-Review von Destination Essentials 1; echte Official-Provider-Evidence bleibt separat gegatet |
