...
- Closure-Review-Blocker (`officialClass` in Konfliktsignatur, strikte Legacy-Singularfelder an der API) umgesetzt; vollständiges Gate folgt; Draft bleibt Draft
