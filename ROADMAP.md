...
S1 Shared Operational Contract ist auf `main` gemergt: PR #47 / `01761eb9`. Technical Closure galt für Exact Head `b74096a9`. Es zentralisiert nur technische Hüllen. Audit-PR #45 bleibt Draft. S1 aktiviert keine Provider und schließt nicht `FlugNachweis`, persistente Kostenschranken oder Admin-Health. S2 nur mit neuem Auftrag.
