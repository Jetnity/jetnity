-- S2-B1: public.reise_anlegen(jsonb) persistiert keine unbewiesenen Flug-Handelsfelder.
-- Authenticated Clients können die RPC direkt aufrufen; Browser-JSON ist keine Providerquelle.
-- Nur die fünf kommerziellen Flugfelder werden für kind='flight' verworfen.
-- Route-Itinerary, User-Intake und Hotel/Activity/Mobility/Rental bleiben unverändert.
-- Keine Service-Role-, Auth-, Grant- oder Trigger-Änderung.
