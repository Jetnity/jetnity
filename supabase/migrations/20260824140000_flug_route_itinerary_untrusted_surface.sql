-- PR #38 R16 Blocker 31: untrusted Client darf surfaceFromAirportCode nicht persistieren.
-- Ersetzt public.flug_route_itinerary_metadata, ohne bereits angewandte Migrationen umzuschreiben.
-- Es gibt in dieser Foundation keinen trusted Surface-Schreibpfad.
...
comment on function public.flug_route_itinerary_metadata(text, jsonb) is
  'Baut trip_items.metadata aus IATA + public.airports. Client-countryCode/city/country und Client-surfaceFromAirportCode werden verworfen. Ungültige Eingaben ergeben {}.';
