...
7. **Gewissheit ist an die amtliche Lage gebunden, auf die sich die Auskunft beruft – nicht an die Reise.** Die blosse Anwesenheit einer geprüften Official-Lage im Kontext genügt nicht: Sonst würde eine aktuelle Passgültigkeitsprüfung den Satz „kein Visum erforderlich" tragen, obwohl die Visumslage unbekannt ist, und `unknown` wäre zu `not_required` aufgewertet. Die Bedingung ist deshalb zweiseitig: Die Auskunft muss mindestens einen belegten Official-Bezug **nennen**, und keiner der von ihr genannten Official-Bezüge darf unbelegt sein. Ohne Gewissheitsformulierung bleibt der Verweis auf eine offene Lage unverändert zulässig – das ist der Normalfall dieses Slice.
...
**Nachtrag, 17. September 2026 / Technical-Lead-Re-Review auf `3775d980`:** Zwei Befunde, beide Wahrheitsintegrität. Erstens schaltete eine beliebige geprüfte Official-Lage im Kontext die Gewissheitsprüfung global frei; Punkt 7 oben ist die Korrektur und bindet sie an die genannte Lage. Zweitens entfernte die serverseitige Prüfung unerwartete Felder still, statt fehlzuschlagen; Punkt 4 oben ist die Korrektur (`z.strictObject`). Im selben Review hat der Technical Lead die zuvor blockierte Develop-Anwendung der Migration unabhängig durchgeführt und verifiziert (siehe `docs/ASSISTANT_RUNTIME_1_STATUS_2026-09-17.md` Abschnitt 4).
