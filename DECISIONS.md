...
8. **Die Antwortsprache ist Deutsch und gehört zum Vertrag, nicht zum Prompt.** Die Prüfung aus Punkt 7 liest Modalität, Bereich und Vorbehalt über deutsche Muster und ist nur über einer **geschlossenen** Sprachfläche vollständig. Solange die Auskunft „in der Sprache der Frage" antworten durfte, war die Fläche offen, und „No visa is required" ging nicht wegen einer Regellücke durch, sondern weil keine Regel dafür zuständig war. Eine Denylist über einer offenen Fläche ist unvollständig; über einer geschlossenen ist sie eine Prüfung. Zwei Schranken sichern das gegenseitig ab: Eine Antwort ohne deutsche Funktionswörter oder Umlaute gilt nicht als deutsch und fällt – das schliesst jede nicht aufgezählte Sprache; und amtliches Vokabular der übrigen von Jetnity geführten Sprachen (`COUNTRY_LOCALES`) fällt unabhängig davon, also auch in einem gemischtsprachigen Text. Aufgenommen ist dort nur, was **kein** deutsches Wort ist. Deutsch ist ohnehin `COUNTRY_UI_LOCALE`; die Beschränkung nimmt eine Ausweitung zurück, die dieser Slice selbst eingeführt hatte.
...
**Bilanz der fünf Runden:** Jede Korrektur hat den Geltungsbereich um eine Dimension erweitert – vom Kontext auf den genannten Bezug, von dort auf den Anforderungstyp, von dort auf die Gesamttaxonomie und die Aussagerichtung, und schliesslich von einer Sprache auf die Sprachfläche selbst. Die Lehre für vergleichbare Wahrheitsschranken: Die Frage ist nicht „schliesst diese Regel den genannten Fall?", sondern „über welche Dimension lässt sie sich umgehen?" – und die letzte Dimension war nicht der Inhalt, sondern die Zuständigkeit.
