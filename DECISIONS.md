...
7. **Gewissheit ist an die amtliche Lage gebunden, auf die sich die Auskunft beruft – und an die Anforderung, über die sie spricht.** Drei Bedingungen, alle zugleich:
   ...
   Zielvisum, Transitvisum, Impfung, Gesundheitsanforderung und elektronische Reisegenehmigung sind getrennte Bereiche. Formulierungen, die nicht sagen, worüber sie sprechen – „garantiert", „definitiv", „amtlich bestätigt", „problemlos einreisen", „nicht erforderlich" – haben keinen tragfähigen Bereich und fallen **immer** durch. Enthält ein Text mehrere Gewissheiten, braucht jede ihren eigenen Beleg. Ohne Gewissheitsformulierung bleibt der Verweis auf eine offene Lage unverändert zulässig – das ist der Normalfall dieses Slice.
