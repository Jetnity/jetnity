...
4. Ungültiger oder unbekannter Purpose, Marketinglabels und ungültige Action-URLs erzeugen keine riskante Action. Sie dürfen eine ansonsten vertrauenswürdige Evaluation nicht nach `not_required` oder anderer Hard Truth umdeuten. Action-Metadaten sind Navigation, nicht Requirements-Wahrheit, und gehören nicht in `officialEvidenceVertrauenswuerdig`.
