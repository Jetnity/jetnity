...
**5. Admin Control Center vs. bestehendes Backoffice.** `docs/ADMIN_PLATFORM_PRODUCT_MODEL.md` fordert eine Steuerzentrale. Der Code ist ein gehärtetes, unvollständiges Backoffice. Der Audit-Vorschlag (nicht freigegeben): vorhandenen Admin weiterverwenden, nicht parallel neu bauen; keine Implementierung vor Technical-Lead-/Product-Owner-Freigabe. Siehe `docs/ADMIN_PLATFORM_AUDIT.md`.
