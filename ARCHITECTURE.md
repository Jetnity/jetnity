...
Gültig für: Foundation D/E, Travel Safety, Travel Timing & Seasonal Intelligence, Account AP-1–AP-3, Admin Slice A–C, Provider S1–S3 und S5-A, Trip Workspace TW-1/2/4/3/5 und TW6-A, D0-1/D0-2, die fail-closed Public-Metadata-Grenze (PR #86 / ADR-0170) sowie den zentralen Admin-AAL2-Application-Guard auf `main`. Account-Slices ändern kein Schema. S2-B1/B2- und die historische Admin-AAL2-Data-Plane-Migration `20260826090000` liegen nur auf Development. Die forward-only Alignment-Datei `20260827170000_admin_aal2_data_plane_alignment.sql` ist auf Draft-PR #98 vorbereitet und nicht Production-approved (ADR-0175). Operativer Stand: `docs/CHATGPT_FINAL_CONTINUITY_HANDOFF_CHECKPOINT_2026-08-26.md`.
