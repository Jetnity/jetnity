...
Gültig für: Phase 3.3c plus Mobile-UX Iteration 1–3, Coverage/Booking und Foundation A/B/C auf `main`; Foundation C (Travel Readiness) Development-Schema, kein Production-Schema, kein Requirements-Provider
...
| `api/readiness/requirements` | geschlossene Requirement-Naht | Foundation C PR #32 auf `main`, kein Provider, Production-Schema unverändert |
