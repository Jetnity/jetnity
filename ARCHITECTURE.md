...
Gültig für: Foundation D und E auf `main` und Production; Travel Safety & Disruption Intelligence auf `main`; Travel Timing & Seasonal Intelligence auf `main` und Production nach PR #38 (`ee988bbe`). Production hat die Route-Surface-Migrationen; Client-Surface wird verworfen. `seasonalProviderAus()` bleibt `null`.
