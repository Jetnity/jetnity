...
lib/commercial-provenance/ S5-A Domainvertrag für Commercial Provenance; keine Persistenz, keine Provideraktivierung (ADR-0168). S5-B Zielarchitektur Option C angenommen (ADR-0197) — **nicht implementiert**.
