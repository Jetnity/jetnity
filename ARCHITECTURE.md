...
Gültig für: Foundation D und E auf `main` und Production; Travel Safety & Disruption Intelligence auf `main`; Travel Timing & Seasonal Intelligence als provider-neutrale Foundation auf `main` nach Squash-Merge von PR #38 (`ee988bbe`). Production hat die Route-Surface-Migrationen `20260824120000` und `20260824140000`; Client-Surface wird verworfen. `seasonalProviderAus()` bleibt `null`.
