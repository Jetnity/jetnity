...
Gültig für: Foundation D/E, Travel Safety, Travel Timing & Seasonal Intelligence sowie Account AP-1/AP-2, Admin Slice A+B, Provider S1 und S2 auf `main` `e3bad749`; Provider Readiness S3 auf `feat/provider-mobility-rental-evidence-s3`. Account-Slices ändern kein Schema. S2-B1/B2-Migrationen liegen nur auf Development und sind nicht Production-approved.
