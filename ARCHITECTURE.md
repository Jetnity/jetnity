...
AP-1–AP-4 sind integriert und werden nicht neu geplant. AP-5–AP-12 bleiben ungebaut. AP-5 Gate 0 rekonstruiert den bestehenden Auth-/Session-/MFA-Vertrag (ADR-0182) und startet keine Runtime. Current Traveller Truth bleibt trip-scoped. AP-7 bleibt hinter Shared-Contract + Product-Owner + ADR-Nachfolger. Die historische Datei auf Draft-PR #39 ist keine Current Truth.
