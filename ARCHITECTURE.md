...
| Assistant-Ausgabevertrag | `lib/reisebegleiter/schema.ts`, `lib/reisebegleiter/pruefung.ts` | Vier Felder, kein Feld für Anforderung, Preis, Anbieter, Buchung oder Quelle. Betrag und Link werden abgelehnt statt entfernt. Zweite Schranke: unbekannter Bezug, Buchungsbehauptung, behauptete Änderung, unbelegte Gewissheit (ADR-0212) |
