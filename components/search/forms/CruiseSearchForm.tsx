...
function Passengers({ value, onChange, label }: { value: Pax; onChange: (v: Pax) => void; label: string }) {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div role="dialog" aria-label="Passagiere" className="absolute right-0 z-20 mt-2 w-[26rem] max-w-[95vw] rounded-2xl border border-zinc-200 bg-white p-4 shadow-xl">
...
function CabinPicker({ value, onChange }: { value: Cabin; onChange: (v: Cabin) => void }) {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div role="dialog" aria-label="Kabinenkategorie" className="absolute right-0 z-20 mt-2 w-[28rem] max-w-[95vw] rounded-2xl border border-zinc-200 bg-white p-4 shadow-xl">
