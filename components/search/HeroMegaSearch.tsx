...
import {
  Plane, Hotel, Car, Ship, Bus, Train, Route as RouteIcon, Activity as ActivityIcon, Navigation
} from 'lucide-react'
...
type TabType =
  | 'flight' | 'hotel' | 'car' | 'activity' | 'ferry' | 'bus' | 'train' | 'cruise' | 'combo' | 'transfer'
...
const TABS: { key: TabType; label: string; icon: React.ElementType }[] = [
  ...
  { key: 'transfer', label: 'Transfer',     icon: Navigation },
]
