...
export const ADMIN_ACCOUNT_COUNTS_WINDOW_US =
  BigInt(ADMIN_ACCOUNT_COUNTS_WINDOW_HOURS) * 3600n * 1_000_000n

export const ADMIN_ACCOUNT_COUNTS_MAX_SIGNED_BIGINT = 9223372036854775807n

export const ADMIN_ACCOUNT_COUNTS_MAX_SIGNED_BIGINT_TEXT = '9223372036854775807'
