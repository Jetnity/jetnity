...
function option(
  ...
  return {
    ...
    title: werte.title,
    description: werte.description !== undefined ? werte.description : null,
    locationName: werte.locationName !== undefined ? werte.locationName : 'Florenz',
    punkt: werte.punkt !== undefined ? werte.punkt : { lat: 43.77, lon: 11.25 },
    dauerMinuten: werte.dauerMinuten !== undefined ? werte.dauerMinuten : 90,
    timeslot: werte.timeslot !== undefined
      ? werte.timeslot
      : {
          startsOn: '2026-09-12',
          startsAt: '15:00',
    ...
    preis: werte.preis !== undefined ? werte.preis : 42,
    preisWaehrung: werte.preisWaehrung !== undefined ? werte.preisWaehrung : 'CHF',
    bewertung: werte.bewertung !== undefined ? werte.bewertung : 8.6,
    bewertungenAnzahl: werte.bewertungenAnzahl !== undefined ? werte.bewertungenAnzahl : 800,
    stornierbar: werte.stornierbar !== undefined ? werte.stornierbar : true,
