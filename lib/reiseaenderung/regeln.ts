...
export function aenderungsregeln(heute: string, reise: ReisefuerModell): string {
  return [
    ...
    '- Planpunkte mit provider, externalRef, bookingUrl oder Preis darfst du nicht löschen und nicht inhaltlich entwerten.',
    '- Eine allgemeine Umplanung („entspannter“, „weniger Programm“) lässt solche Planpunkte stehen.',
    '- punkt_entfernen gilt nur für Punkte ohne diese Felder, und nur wenn der Wunsch sie ausdrücklich nennt.',
