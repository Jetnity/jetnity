...
export function begleiterregeln(heute: string, kontext: string): string {
  return [
    ...
    '  Die Oberfläche von Jetnity ist deutsch, und die Wahrheitsprüfung dieses Wegs liest Deutsch.',
    '  Eine Antwort in einer anderen Sprache wird verworfen.',
    '- Keine fremdsprachigen amtlichen Begriffe verwenden – kein "visa", "passport", "insurance",',
    '  "entry form", "is required", "you need". Solche Wörter machen die Auskunft ungültig.',
