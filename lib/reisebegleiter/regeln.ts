...
export function begleiterregeln(heute: string, kontext: string): string {
  return [
    ...
    '- Die Wörter "visumfrei", "visafrei", "kein Visum", "ohne Visum", "keine Impfung",',
    '  "nicht erforderlich", "garantiert", "definitiv", "amtlich bestätigt" und',
    '  "problemlos einreisen" nicht verwenden, solange keine geprüfte amtliche Lage vorliegt.',
    '  Benenne stattdessen den Prüfstand aus dem Kontext.',
