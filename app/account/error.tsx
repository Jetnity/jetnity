...
/**
 * Fehlergrenze für Routen unter /account.
 * Fängt Renderfehler im Konto-Teilbaum ab. Keine Aussage über Datenintegrität
 * und keine Behauptung, die Fehler-ID sei operatorseitig nachverfolgbar.
 */
      ...
      <div className="mx-auto max-w-2xl">
        <div className="rounded-[30px] border border-black/5 bg-white p-6 shadow-[0_20px_60px_rgba(15,46,42,0.07)] sm:p-10">
          ...
          <p className="mt-4 text-sm leading-6 text-ink-800">
            Das kann an einer instabilen Verbindung oder an einem kurzfristigen Serverproblem
            liegen. Du kannst es erneut versuchen oder den Kontobereich verlassen.
          </p>
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            <button
              type="button"
              onClick={() => reset()}
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-brand-800 px-5 text-sm font-semibold text-white transition hover:bg-brand-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
            ...
            <Link
              href="/reisen"
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full border border-line-300 bg-white px-5 text-sm font-semibold text-brand-800 transition hover:border-line-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
