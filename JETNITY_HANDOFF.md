...
**Phase 3.3 Activities Foundation ist in Arbeit** auf Branch `phase-3-3-activities-foundation`, Draft-PR #24. Die Foundation ist integrationsbereit: Tageskontext, Konfliktlogik, provisionsneutrales Ranking, Nachweis-Naht an Ziel/Datum/Teilnehmer/Währung/Timeslot, Such-Body vor Allokation begrenzt. Ein echter Activity-Provider ist noch nicht angebunden. Die Konto-Übernahme ist fail closed, bis ein `ActivityNachweis` existiert. Fachlich: `docs/ACTIVITIES.md`.
...
1. Phase 3.3 Activities Foundation auf `phase-3-3-activities-foundation` / Draft-PR #24 ist der aktuelle Aktivitätsstand. Nächste Freigabe: genau einen ersten Activity-Datenanbieter plus `ActivityNachweis`, nicht Production. Siehe `docs/ACTIVITIES.md`.
