...
Die sichtbaren Ziele sind Übersicht, Flüge, Unterkunft und Aktivitäten. Der Tagesplan gehört in die Übersicht und hat keinen eigenen Tab. Die Navigation ist eine robuste Button-Leiste, kein unvollständiges ARIA-Tabs-Muster. Auf Desktop (`lg`) entfällt sie; dort bleibt die bisherige breite Arbeitsansicht.
